...
struct dest_t
{
	dest_type type; /* only type_fd64 and type_fd_addr used */
	inner_t inner;
	u32_t conv;
	int cook = 0;
};
...
int new_connected_socket2(int &fd, address_t &addr, address_t *bind_addr, int);
